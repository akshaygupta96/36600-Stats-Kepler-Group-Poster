...
best_model_pred <- ifelse(prob_xgb > best_threshold, 1, 0)
...
lg_roc <- roc(df.test$label, prob_lr)
rf_roc <- roc(df.test$label, prob_rf)
svm_roc <- roc(df.test$label, prob_svm)
knn_roc <- roc(df.test$label, prob_knn) 
gbm_roc <- roc(df.test$label, prob_gbm)
xgb_roc <- roc(df.test$label, prob_xgb)
